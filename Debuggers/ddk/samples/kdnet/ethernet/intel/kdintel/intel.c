...
//
// Main entry points into the Intel 2.5GBit EFI driver code.
//

EFI_STATUS
E2500InitializeUNDIDriver (
  VOID
  );

EFI_STATUS
E2500UndiDriverSupported (
  VOID
  );

EFI_STATUS
E2500UndiDriverStart (
  VOID
  );
...

{
    ...
    //
    // Set the UNDI driver function pointers for the Intel 2.5GBit UNDI driver.
    //

    UndiInitializeDriver  = E2500InitializeUNDIDriver;
    UndiHardwareSupported = E2500UndiDriverSupported;
    UndiDriverStart = E2500UndiDriverStart;
    UndiApiEntry = E2500UndiApiEntry;
