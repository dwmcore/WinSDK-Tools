  ...
  if (!EFI_ERROR (Status)) {
    ...
    if (Pci.Hdr.VendorId == INTEL_VENDOR_ID) {
      if (
        ...
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_ARL_I219_LM24 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_ARL_I219_V24 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_PTL_I219_LM25 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_PTL_I219_V25 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_PTL_I219_LM26 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_PTL_I219_V26 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_PTL_I219_LM27 ||
        Pci.Hdr.DeviceId == E1000_DEV_ID_PCH_PTL_I219_V27 ||
